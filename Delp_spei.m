...
for i = 1:60
    for j = 1:720
        if nsdmask(i,j) == 1
                ...
                %模拟
                data.td = [t (squeeze(spei(i,j,:))+3)/6];
                data.pho = po;
                data.ydata = phen;
                ...
                AICc=2*n*log(rmse)+2*7+2*7*(7+1)/(34-7-1);
                r = corr(phen(:,2),pred);
                fprintf(fid,' %6i %6i   %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f %6.2f   %6.2f %6.1f %6.1f \n',i,j,fpa,r,rmse,AICc);
